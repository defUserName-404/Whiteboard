...
public class MainWindowController implements Initializable {
	...
	@FXML
	public MenuButton tool, shapeOptions;
	@FXML
	public MenuItem penTool, eraserTool, textTool, lineTool, circleTool, rectangleTool, imageTool, clearTool;
	@FXML
	public ToolBar toolBar;
	@FXML
	public Spinner<Integer> sizeSpinner;
	@FXML
	public StackPane canvasHolder;
	@FXML
	public RadioMenuItem shapeFill, shapeStroke;
